...
class ApplicationController < ActionController::Base
  ...
  # TODO: do I need this in Rails 3.2?
  ...
  helper_method :lineage
	...
	#------ what follows is important app code, used by all controllers ---------

	# gets called before every action (NEEDED for all controllers - Greg N)
